        ...
        <div class="row">
            <div class="col-12 col-md-8">
                ...
                <tbody>
                    ...
                    <!-- --- START OF YOUR CODE --- -->
                    <?php 
                    foreach($videogameList as $videogameListContent) : ?>
                        <tr>
                        <td><?= $videogameListContent['id']?></td>
                        <td><?= $videogameListContent['name']?></td>
                        <td><?= $videogameListContent['editor']?></td>
                        <td><?= $videogameListContent['release_date']?></td>
                        <td><?= $platformList[$videogameListContent['platform_id']]?></td>
                        </tr>
                    <?php endforeach?>
                    <!-- --- END OF YOUR CODE --- -->
                </tbody>
            ...
            <div class="col-12 col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group">
                                <label for="nameDelete">Nom du jeu</label>
                                <input type="text" class="form-control" name="nameDelete" id="nameDelete" placeholder="Theme Hospital">
                            </div>
